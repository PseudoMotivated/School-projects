...
void loop(){                     // Makes a servo rotate back and forth 180 degrees repeatedtly
  ...
  myServo.write(100);            // Tells the servo to rotate to the 100 degree position.
  delay(440);                    // Gives the servo time to rotate.

  myServo.write(50);             // Tells the servo to rotate to the 50 degree position.
  delay(200);                    // Gives the servo time to rotate.. 
